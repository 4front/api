...
module.exports = function() {
  ...
  router.post('/', [hasRole('admin'), validateDomainName, ensure.domainManager], function(req, res, next) {
    ...
    async.waterfall([
      function(cb) {
        ...
        if (!domainData.certificate) return cb(null, null);
      ...
      function(zone, cb) {
        req.app.settings.domains.register(domainName, zone, cb);
      },
      function(zone, cb) {

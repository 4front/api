...
module.exports = function() {
  ...
  function del(req, res, next) {
    req.app.settings.database.deleteEnvironmentVariable(req.ext.virtualApp.appId, req.params.env, req.params.key, function(err) {
      if (err) return next(err);
  ...
  function reloadApp(req, res, next) {
    req.app.settings.virtualAppRegistry.getById(req.ext.virtualApp.appId, {forceReload: true}, function(_err, virtualApp) {
